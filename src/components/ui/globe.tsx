  ...
  return (
    <>
      <style>{`
        ...
        @keyframes twinkling      { 0%,100%{opacity:.1;} 50%{opacity:1;} }
        @keyframes twinkling-slow { 0%,100%{opacity:.1;} 50%{opacity:1;} }
        @keyframes twinkling-long { 0%,100%{opacity:.1;} 50%{opacity:1;} }
        @keyframes twinkling-fast { 0%,100%{opacity:.1;} 50%{opacity:1;} }
      `}</style>
      <div className="flex items-center justify-center h-screen">
        <div
          className="relative w-[250px] h-[250px] rounded-full overflow-hidden shadow-[0_0_20px_#FDFBD433,-5px_0_8px_#D9D7B6_inset,15px_2px_25px_#000_inset,-24px_-2px_34px_#D9D7B699_inset,250px_0_44px_#00000066_inset,150px_0_38px_#000000aa_inset]"
          style={{
